...
import com.personio.reminders.infra.postgres.PostgresRemindersOccurrencesRepository
...
@PostgresSpringTest
@SpringBootTest
internal class PostgresRemindersOccurrencesRepositoryTest : RemindersOccurrencesRepositoryContractTest {
    @Autowired
    ...
    override fun subjectWithData(
        ...
        return PostgresRemindersOccurrencesRepository(dslContext, clock)
    }
